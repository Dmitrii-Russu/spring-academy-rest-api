package message.unit.controller;

import message.controller.MessageController;
import message.model.Message;
import message.security.SecurityConfig;
 ...
 * This test class uses {@link MockMvc} to test the HTTP endpoints of the {@link MessageController}.
 * It mocks the behavior of the {@link MessageService} to simulate the service layer,
 * allowing tests of the controller's functionality without requiring the full Spring context or database setup.
 * The tests cover various HTTP operations, security configurations, status codes, and response validation.
 */
@Tag("unit")
